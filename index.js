...
const searchInNodeByName = (node, nodeName) => {
  ...
  if (node['name'] === nodeName) {
    ...
    return children.reduce((state, node) => {
      return searchInNodeByName(node, nodeName) || state;
    }, undefined);
  } else {
    return undefined;
  }
...
const valueIsRecord = (value) =>
  value !== null && typeof value === 'object' && !Array.isArray(value);

const node6 = searchInNodeByName(rootNode, 'node6');

if (node6 === undefined || !valueIsRecord(node6) || node6.name !== 'node6') {
